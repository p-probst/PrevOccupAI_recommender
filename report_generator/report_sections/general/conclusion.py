...
SECTION_1_PT = (
    ...
    "mas também na promoção da saúde ocupacional de todos os trabalhadores da Câmara Municipal de Lisboa."
)
...
CONCLUSION_DICT = {
    PT: {
        SECTION_0: SECTION_0_PT, # please define the sections as constants as well
